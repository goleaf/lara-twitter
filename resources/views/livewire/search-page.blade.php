            ...
            <div class="card-body">
                ...
                <div class="space-y-2 pt-2">
                    @forelse ($this->users as $u)
                        <a class="flex items-center justify-between gap-3 rounded-box border border-base-200 bg-base-100 px-3 py-2 hover:bg-base-200/50 hover:border-base-300 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20" href="{{ route('profile.show', ['user' => $u]) }}" wire:navigate>
