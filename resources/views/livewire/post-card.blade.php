            ...
            <div class="min-w-0 flex-1 flex flex-col gap-2">
                @if ($this->isRepost())
                    <div class="flex items-center">
                        <span class="inline-flex items-center gap-1.5 rounded-full border border-base-200 bg-base-200/60 px-2 py-1 text-xs text-base-content/70">
                            ...
                            <span>
                                Retweeted by
                                <a class="link link-hover text-base-content" href="{{ route('profile.show', ['user' => $post->user->username]) }}" wire:navigate>
                                    &#64;{{ $post->user->username }}
                                </a>
                            </span>
                        </span>
                ...
                @if ($replyingTo)
                    <div class="flex items-center">
                        <span class="inline-flex items-center gap-1.5 rounded-full border border-base-200 bg-base-200/60 px-2 py-1 text-xs text-base-content/70">
                            ...
                            <span>
                                Replying to
                                <a class="link link-hover text-base-content" href="{{ route('profile.show', ['user' => $replyingTo]) }}" wire:navigate>
                                    &#64;{{ $replyingTo }}
                                </a>
                            </span>
                        </span>
