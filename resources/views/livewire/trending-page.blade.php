                ...
                <div class="card-body">
                    ...
                    <div class="space-y-2 pt-2">
                        @forelse ($this->trendingTopics as $row)
                            <a class="flex items-center justify-between gap-3 rounded-box border border-base-200 bg-base-100 px-3 py-2 hover:bg-base-200/50 hover:border-base-300 transition focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/20" href="{{ route('explore', ['tab' => $row['category']]) }}" wire:navigate>
                                <div class="min-w-0">
                ...
                <div class="card-body">
                    ...
                    <div class="space-y-2 pt-2">
                        @forelse ($this->trendingHashtags as $tag)
                            <div class="flex items-start justify-between gap-3 rounded-box border border-base-200 bg-base-100 px-3 py-2 hover:bg-base-200/50 hover:border-base-300 transition focus-within:ring-2 focus-within:ring-primary/20">
